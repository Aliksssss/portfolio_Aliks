  ...
  return (
    ...
    >
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        ...
        >
          <span className="text-white mr-1">Shingru</span>
          <span
            className="w-12 h-8 rounded bg-white text-black
      ...
      <div className="md:hidden">
        ...
        >
          ...
          animate={open ? "opened" : "closed"} className="w-10 h-1 bg-black rounded origin-left"></motion.div>
