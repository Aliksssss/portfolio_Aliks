            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    I utilized Azure cloud services along with React and Typescript to develop over 20 features for applications.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                    Junior Full Stack Web Developer Student & Teaching Assistant
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I completed over 640 hours of coding experience, constructing multiple full-stack web applications while gaining working proficiency in various front-end and back-end languages and frameworks, with a focus on Test Driven Development.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I completed the RN new graduate program with over 400 hours of classroom and clinical experience about communication, interventions, and detailed analysis.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
