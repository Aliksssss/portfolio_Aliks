  ...
  return (
    <div className={styles.container}>
      <div className={styles.imageWrapper}>
        <div className="py-6 px-6" onMouseEnter={() => handleMouseEnter('En nuestra agencia de publicidad nos enorgullece ofrecer soluciones creativas e innovadoras para promover y posicionar marcas en el mercado')} onMouseLeave={handleMouseLeave}>
          <Image src="/agencia_2.png" alt="Agencia" width={350} height={150} />
        </div>
        <div className="py-6 px-6" onMouseEnter={() => handleMouseEnter('En nuestra consultoría de comunicación y estrategia nos especializamos en ayudar a las empresas a desarrollar y ejecutar estrategias de comunicación efectivas y a medida')} onMouseLeave={handleMouseLeave}>
          <Image src="/consultoria_2.png" alt="Agencia" width={350} height={150} />
        </div>
        <div className="py-6 px-6" onMouseEnter={() => handleMouseEnter('En nuestra central de medios nos dedicamos a ofrecer soluciones integrales y efectivas para la planificación, compra y ejecución de estrategias de medios')} onMouseLeave={handleMouseLeave}>
